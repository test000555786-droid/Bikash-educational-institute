...
const highlights = [
  { icon: Clock,  title: '10+ Years Experience', desc: 'Established in 2010, we have nurtured hundreds of young learners across Cuttack with quality primary education.', color: 'bg-blue-50', iconColor: 'text-blue-600', border: 'border-blue-100', image: '/images/faculty/b&s.webp' },
